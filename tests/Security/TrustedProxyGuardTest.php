...
final class TrustedProxyGuardTest extends TestCase
{
    ...
    public function testRejectsRfc7239ForwardedHeaderFromUntrustedPeer(): void
    {
        $this->expectException(\RuntimeException::class);
        ...
        TrustedProxyGuard::assertNoUntrustedForwardedHeaders(
            [
                'REMOTE_ADDR' => '203.0.113.10',
                'HTTP_FORWARDED' => 'proto=https; for=198.51.100.1',
            ],
            ['127.0.0.1', '::1'],
        );
    }
    ...
    public function testHonorsRfc7239ForwardedProtoHttpsFromTrustedPeer(): void
    {
        $trusted = ['10.0.0.0/8', '::1', '2001:db8::/32'];
        ...
        self::assertTrue(TrustedProxyGuard::isForwardedHttpsFromTrustedProxy(
            [
                'REMOTE_ADDR' => '2001:db8::1234',
                'HTTP_FORWARDED' => 'for=198.51.100.1; proto="https"; by=203.0.113.43',
            ],
            $trusted,
        ));

        // Prefer X-Forwarded-Proto over Forwarded when both exist.
        self::assertFalse(TrustedProxyGuard::isForwardedHttpsFromTrustedProxy(
            [
                'REMOTE_ADDR' => '10.1.2.3',
