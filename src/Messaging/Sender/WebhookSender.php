...
if (class_exists('BlackCat\\Messaging\\CoreCompat\\CoreWebhookSender')) {
    class_alias('BlackCat\\Messaging\\CoreCompat\\CoreWebhookSender', __NAMESPACE__ . '\\WebhookSender');
    return;
}
